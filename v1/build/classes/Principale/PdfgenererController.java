...
Servicebacklog_pd ps=new Servicebacklog_pd();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            set1.getData().add(new XYChart.Data<>("priorité num 1",bcs.countNbOfferByCpriority(5)));
            set1.getData().add(new XYChart.Data<>("priorité num 30",bcs.countNbOfferByCpriority(2)));
            set1.getData().add(new XYChart.Data<>("priorité num 60",bcs.countNbOfferByCpriority(60)));
