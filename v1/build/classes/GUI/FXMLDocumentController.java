...
public class FXMLDocumentController implements Initializable {
    ...
    private void homebtna(ActionEvent event) throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("AfficheDocument.fxml"));
    ...
    private void reclamation(ActionEvent event) throws IOException {
        ...
        @FXML
    private void intervention(ActionEvent event) throws IOException {
         MainPane.getChildren().clear();
        Parent parent = FXMLLoader.load(getClass().getResource("Intervention.fxml"));
        MainPane.getChildren().add(parent);
        MainPane.toFront();
    ...
    private void formation(ActionEvent event) throws IOException {
         MainPane.getChildren().clear();
        Parent parent = FXMLLoader.load(getClass().getResource("Formation.fxml"));
        MainPane.getChildren().add(parent);
        MainPane.toFront();
